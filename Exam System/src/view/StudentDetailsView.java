...
public class StudentDetailsView {
    ...
    public StudentDetailsView(UserController controller) {
    ...
    public void displayStudentDetails(String[][] studentDetails) {
        ...
        for (String[] details : studentDetails) {
            ...
            JLabel studentLabel = new JLabel("<html><b>SRN:</b> " + details[0] + "<br><br><br><b>Name:</b> " + details[1] + "<br><br><br><b>Department:</b> " + details[2] + "<br><br><br><b>SEM:</b> " + details[3] + "</html>");
            studentLabel.setFont(new Font("Arial", Font.PLAIN, 20));
            detailPanel.add(studentLabel, BorderLayout.CENTER);
